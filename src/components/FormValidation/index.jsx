...
export const formSchema = Yup.object({
  ...
  cardDesc: Yup.string()
    ...
    .max(500)
    .required("Please enter a Description"), // displays error if card disc is less than 3 chars and does not allow more than 15 chars
  ...
  terms: Yup.array(
    ...
    Yup.object({
      ...
      termDef: Yup.string()
        .min(3, "Term Definition must be atleast 3 Chars long")
        .max(500)
        .required("Please enter a Term definition"), // displays error if term definition is less than 3 chars and does not allow more than 15 chars
